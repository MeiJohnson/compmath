...
double intfunc(double x){
  return sin(0.2*x*x+0.7)/(1.4+cos(0.5*x+0.2));
}
...
double derive(double x0, int num){
  switch (num) {
  case 1: return (0.4*x0*cos(0.2*x0*x0+0.7))/(cos(0.5*x0+0.2)+1.4)+(0.5*sin(0.5*x0+0.2)*sin(0.2*x0*x0+0.7))/((cos(0.5*x0+0.2)+1.4)*(cos(0.5*x0+0.2)+1.4));
  case 2: return 0;
  case 5: return 0;
  }
}
